                ...
                <div class="design-card card-hover bg-white rounded-2xl overflow-hidden group flex flex-col h-full">
                    ...
                    <div class="relative">
                        @if($design->design_img)
                            <div class="aspect-[4/3] overflow-hidden cursor-pointer" onclick="openGallery({{ $loop->index }})">
                                <img src="{{ asset('storage/' . $design->design_img) }}" alt="{{ $design->name }}" 
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                            </div>
                        @else
                            <div class="aspect-[4/3] bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center cursor-pointer" onclick="openGallery({{ $loop->index }})">
