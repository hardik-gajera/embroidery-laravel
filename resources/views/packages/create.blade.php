...
@section('subtitle', 'Create a new design package')
...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    <div class="px-6 py-4 bg-primary-600 text-white flex items-center gap-3">
        ...
        <div>
            <h3 class="text-sm font-heading font-semibold">New Package</h3>
            <p class="text-xs text-primary-200">Create a design subscription package</p>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('packages.store') }}" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-3 mt-6 pt-5 border-t border-gray-100">
                ...
                <button type="submit" class="px-5 py-2.5 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition text-sm font-medium">
                    <i class="fas fa-check mr-1.5"></i>Save Package
                </button>
            </div>
        </form>
    </div>
